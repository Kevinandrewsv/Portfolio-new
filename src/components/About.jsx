  ...
  return (
    <div className="flex justify-between">
      <motion.div variants={fadeIn("right", "spring", 0.4, 2)}>
        {/* Greeting */}
        <h1 className="flex items-center animate-pulse font-semibold -mt-20 mb-5 w-fit gap-2">
        ...
        {/* Hero sub-text */}
        <p className={`${styles.heroSubText} inline-flex items-center text-white`}>
...
<div className="mt-6 flex gap-4">
  ...
  >
    Contact Me
      ...
      {/* Social icons */}
      <div className="text-indigo-400 opacity-90 space-y-9 mt-8">
        {socialLinks.map((socialLink, idx) => (
          <motion.div key={idx} variants={fadeIn("left", "spring", 0.4, 1.7)}>
