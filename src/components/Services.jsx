...
const Services = () => {
  ...
  return (
    <>
      {/* “About Me” banner with scroll-into-view animation */}
      <section
        id="about"
      ...
      {/* Content below */}
      <div id="services" className="px-4 md:px-12 lg:px-20 mt-8">
        ...
        {/* Portrait is hidden below md; side-by-side on md+ */}
        <div
          className="
            flex flex-col-reverse md:flex-row
            justify-center md:justify-start
            items-center
            gap-y-10        /* vertical on mobile */
            md:gap-y-0      /* zero vertical once side-by-side */
            gap-x-0         /* zero horizontal on mobile */
            md:gap-x-32     /* 8rem horizontal on md+ */
          "
        >
          ...
          <motion.div
            ...
            animate={controls}
            whileHover="hover"
            className="hidden md:block relative w-[240px] lg:w-[256px] h-[240px] lg:h-[256px] group cursor-pointer"
          >
            <motion.div
            ...
            <motion.div
              ...
              style={{ boxShadow: "0 0 0 rgba(80,120,220,0.0)" }}
              variants={{
                draw: {
                  boxShadow: [
          ...
          <motion.div
            ...
            className="w-full md:flex-1 text-between md:text-left"
          >
            ...
            <p className="text-secondary text-[16px] md:text-[17px] leading-[26px] md:leading-[30px] mb-6">
            ...
            <p className="text-secondary text-[16px] md:text-[17px] leading-[26px] md:leading-[30px] mb-8">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4">
              <button className="px-4 py-2 flex items-center gap-2 bg-gray-900 hover:bg-gray-600 rounded-full transition">
